...
[_NEWSPECIAL] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______, KC_LPRN, KC_LCBR, _______, _______, KC_RCBR, KC_RPRN, _______, _______, _______,
    _______, _______, _______, KC_LABK, KC_LBRC, _______, _______, KC_RBRC, KC_RABK, _______, _______, _______,
