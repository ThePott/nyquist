...
[_RAISE] = LAYOUT_ortho_4x12(
    ...
    KC_TILD, KC_LBRC,      KC_LABK,      KC_LPRN,  KC_LCBR,         KC_QUOTE, _______,       KC_RCBR, KC_RPRN,  KC_RABK, KC_RBRC, _______,
    _______, KC_SEMICOLON, KC_BACKSLASH, KC_COLON, KC_DOUBLE_QUOTE, KC_MINUS, KC_UNDERSCORE, KC_EQL,  KC_SLASH, _______, _______, _______,
