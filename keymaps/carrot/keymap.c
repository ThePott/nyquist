...
[_BASE] = LAYOUT_ortho_4x12(
    ...
    KC_LSFT,       KC_Z,    KC_X,     KC_C,    KC_V,   KC_B,   KC_B,       KC_N,    KC_M,    KC_DOT,  KC_COMM, KC_RSFT,
    MO(_FUNCTION), KC_LEFT, KC_RIGHT, KC_LCTL, KC_SPC, KC_ESC, MO(_RAISE), KC_RSFT, KC_LALT, KC_DOWN, KC_UP,   KC_RGUI
),

[_RAISE] = LAYOUT_ortho_4x12(
    KC_GRV,  KC_0,         KC_1,     KC_2,     KC_3,         KC_4,          KC_5,            KC_6,     KC_7,    KC_8,    KC_9,    _______,
    KC_TILD, KC_LBRC,      KC_LABK,  KC_LCBR,  KC_LPRN,      KC_MINUS,      _______,         KC_RPRN,  KC_RCBR, KC_RABK, KC_RBRC, _______,
    _______, KC_BACKSLASH, KC_SLASH, KC_QUOTE, KC_SEMICOLON, KC_UNDERSCORE, KC_DOUBLE_QUOTE, KC_COLON, KC_EQL,  _______, _______, _______,
...
[_FUNCTION] = LAYOUT_ortho_4x12(
    ...
    _______, _______, KC_UP,   _______,  RM_VALD, _______, _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,
    _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
    _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_NEW] = LAYOUT_ortho_4x12(
    ...
    KC_F13,  KC_LGUI, MO(_LOWER), KC_LALT, KC_SPACE, KC_ESC, MO(_NEWSPECIAL), KC_R,     KC_LCTL,         MO(_FUNCTION), KC_RGUI,  TO(_BASE)
),
