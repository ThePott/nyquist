...
[_BASE] = LAYOUT_ortho_4x12(
  ...
  KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_B,    KC_H,    KC_J,    KC_K,    KC_L, KC_QUOT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ESC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
